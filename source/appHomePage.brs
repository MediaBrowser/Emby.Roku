    ...
    while true
        ...
        if type(msg) = "roGridScreenEvent" Then
            if msg.isListFocused() then
                Debug("list focused | index = " + itostr(msg.GetIndex()) + " | category = ")
            ...
            if (type(msg) = "roUrlEvent")
                ...
                if (code = 200)
                    ...
                    for each itemData in jsonData.Items
                        ...
                        If itemData.BackdropImageTags[0]<>"" And itemData.BackdropImageTags[0]<>invalid
                            tvData.HDPosterUrl = GetServerBaseUrl() + "/Items/" + itemData.Id + "/Images/Backdrop/0?quality=90&height=150&width=&EnableImageEnhancers=false&tag=" + itemData.BackdropImageTags[0]
                            tvData.SDPosterUrl = GetServerBaseUrl() + "/Items/" + itemData.Id + "/Images/Backdrop/0?quality=90&height=94&width=&EnableImageEnhancers=false&tag=" + itemData.BackdropImageTags[0]
