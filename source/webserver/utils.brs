...
function serverDbg(obj as Object, level as String, message as String, code=0 as Integer)
    tag = ""
    if isstr(obj)
        tag = obj
    else    
